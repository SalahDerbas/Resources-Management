    ...
    public function anyData()
    {
        ...
        return Datatables::of($users)
            ...
            ->addColumn('view', function ($user) {
                return '<a href="' . route("users.show", $user->external_id) . '" class="btn btn-primary btn-sm">' . __('View') .'</a>';
            })
            ->addColumn('edit', function ($user) {
                return '<a href="' . route("users.edit", $user->external_id) . '" class="btn btn-success btn-sm">' . __('Edit') .'</a>';
            })
           ->addColumn('delete', function ($user) {
               return '<a href="' . route("users.destroy", $user->external_id) .'" class="btn btn-danger btn-sm">' . __('Delete') .'</a>';
           })
