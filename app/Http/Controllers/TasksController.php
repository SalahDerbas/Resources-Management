    ...
    public function anyData()
    {
        ...
        return Datatables::of($tasks)
            ...
            ->addColumn('view', function ($tasks) {
                return '<a href="' . route("tasks.show", $tasks->external_id) . '" class="btn btn-primary btn-sm">' . __('Views') .'</a>'
                . '<a data-toggle="modal" data-id="'. route('tasks.destroy',$tasks->external_id) . '" data-target="#deletion" class="btn btn-danger btn-sm">' . __('Delete') .'</a>'
                ;
            })
