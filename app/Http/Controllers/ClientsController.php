...
class ClientsController extends Controller
{
    ...
    public function anyData()
    {
        ...
        return Datatables::of($clients)       
            ...
            ->addColumn('view', '
               <a href="{{ route(\'clients.show\', $external_id) }}" class="View btn btn-primary btn-sm" >'  . __('View') . '</a>')
            ->addColumn('edit', '
                <a href="{{ route(\'clients.edit\', $external_id) }}" class="edit btn btn-primary btn-sm" >'  . __('Edit') . '</a>')
            ->addColumn('delete', '
                <form action="{{ route(\'clients.destroy\', $external_id) }}" method="POST">
            <input type="hidden" name="_method" value="DELETE">
            <input type="submit" name="submit" value="' . __('Delete') . '" class="delete btn btn-danger btn-sm" onClick="return confirm(\'Are you sure? All the clients tasks, leads, projects, etc will be deleted as well\')"">
            {{csrf_field()}}
            </form>')
