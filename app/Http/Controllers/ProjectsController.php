    ...
    public function indexData()
    {
        ...
        return Datatables::of($projects)
            ...
            ->addColumn('view', function ($projects) {
                return '<a href="' . route("projects.show", $projects->external_id) . '" class="view btn btn-primary btn-sm">' . __('Views') .'</a>'
                . '<a data-toggle="modal" data-id="'. route('projects.destroy',$projects->external_id) . '" data-title="'. $projects->title . '" data-target="#deletion" class="delete btn btn-danger btn-sm">' . __('Delete') .'</a>';
            })
