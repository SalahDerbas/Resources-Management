<div class="col-sm-3">
    <p class="calm-header">{{ __(' Person Informations')}}</p>
</div>
<div class="col-sm-9" id="primaryContact">
    <div class="form-group">
        {!! Form::label('name', __('Name Client'). ':', ['class' => 'control-label thin-weight']) !!}
        {!! 
            Form::text('name',  
...
<div class="col-sm-3">
    <p class="calm-header">{{ __('Business Informations') }}</p>
</div>
<div class="col-sm-9" id="businessInfo">
    <div class="form-inline">
    <div class="form-group col-sm-6 removeleft">
        {!! Form::label('vat', __('Phone'). ':', ['class' => 'control-label thin-weight']) !!}
        {!! 
            Form::text('vat',
