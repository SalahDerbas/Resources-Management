...
<head>
    ...
    <title>Resources Management - Login</title>
...
<div style="text-align: center; margin-bottom:20px;"><a href="/login">
    <img src="{{ asset('images/resource1.png') }}" width="458px"  
                                                          alt="" style="margin-top:5em; margin-bottom:2em; margin-left: 8%" class="logo-placment"></a></div>
