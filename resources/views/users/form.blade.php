...
<div class="col-sm-3">
    <label for="name" class="base-input-label">Contact Information</label>
</div>
<div class="col-sm-9">
    <div class="form-group col-sm-8">
    ...
    <div class="form-group col-sm-8">
        <label for="primary_number" class="control-label thin-weight">Primary Number</label>
        <input type="number" name="primary_number" class="form-control" value="{{isset($user) ? optional($user)->primary_number : ''}}">
    </div>
    <div class="form-group col-sm-8">
        <label for="secondary_number" class="control-label thin-weight">Secondary Number</label>
...
@if(auth()->user()->canChangeRole())
    <div class="form-group col-sm-8">
        <label for="roles" class="control-label thin-weight">Assign Role</label>
...
@endif
    <div class="form-group col-sm-8">
        <label for="departments" class="control-label thin-weight">Assign Department</label>
