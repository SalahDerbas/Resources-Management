        ...
        <form action="{{route('tasks.store')}}" method="POST" id="createTaskForm">
                ...
                <div class="tablet">
                    <div class="tablet__body">
                            <div class="form-group">
                                <label for="title" class="control-label thin-weight">Task Name</label>
            ...
            <div class="col-sm-4">
                <div class="tablet">
                    <div class="tablet__body">
                        <div class="form-group">
                            <label for="user_assigned_id" class="control-label thin-weight">Assign User</label>
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <label for="client_external_id" class="control-label thin-weight">Assign Client</label>
